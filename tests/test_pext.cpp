...
namespace
{
    ...
    {
        const auto attacks = aurora::chess::bishop_attacks(aurora::chess::Square::D4, 0);
    ...
    {
        const auto attacks =
            aurora::chess::bishop_attacks(aurora::chess::Square::D4, aurora::chess::bit(aurora::chess::Square::E5));
    ...
    {
        const auto attacks =
            aurora::chess::rook_attacks(aurora::chess::Square::D4, aurora::chess::bit(aurora::chess::Square::D6));
